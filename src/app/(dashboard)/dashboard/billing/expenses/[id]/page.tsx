    ...
    <Stack gap="xl" p="md">
      <Group justify="space-between">
        <Stack gap={4}>
          ...
          <Text c="dimmed" size="md">Viewing details for expense ID: {id}</Text>
        </Stack>
        <Button 
          component={Link} 
          href="../" 
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="lg">
              <Group justify="space-between" align="flex-start">
                <div>
                  <Text size="xs" tt="uppercase" fw={700} c="dimmed">Expense ID</Text>
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="md">
              ...
              <Text size="sm" c="dimmed">
                Overview of the current expense. Use the actions below to manage this entry.
              </Text>
              <Button fullWidth color="blue" mt="sm">Print / Download</Button>
              <Button fullWidth variant="light" color="blue">Edit Expense</Button>
