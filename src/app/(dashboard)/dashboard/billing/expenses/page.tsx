...
import {  IconReportMoney, IconSearch, IconEye, IconEdit, IconTrash, IconPlus , IconSelector, IconChevronUp, IconChevronDown } from "@tabler/icons-react";
...
const mockData = [
  ...
  const categories = Array.from(new Set(mockData.map(e => e.category)));
      ...
      <Paper p="md" radius="md" withBorder shadow="sm">
        <Box mb="xl" p="md" style={{ backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="md">
            <TextInput
              label={<Text fw={700} size="xs" mb={5}>Search Expense</Text>}
            ...
            />
            <Select
              label={<Text fw={700} size="xs" mb={5}>Category</Text>}
