      ...
      <Group justify="space-between">
        <Stack gap={4}>
          <Group gap="xs">
            ...
            <Title order={1}>Invoice Details</Title>
          </Group>
          <Text c="dimmed" size="md">Viewing details for invoice ID: {id}</Text>
        </Stack>
        <Button 
          component={Link} 
          href="../" 
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="lg">
              <Group justify="space-between" align="flex-start">
                <div>
                  <Text size="xs" tt="uppercase" fw={700} c="dimmed">Invoice ID</Text>
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="md">
              ...
              <Text size="sm" c="dimmed">
                Overview of the current invoice. Use the actions below to manage this entry.
              </Text>
              <Button fullWidth color="blue" mt="sm">Print / Download</Button>
              <Button fullWidth variant="light" color="blue">Edit Invoice</Button>
