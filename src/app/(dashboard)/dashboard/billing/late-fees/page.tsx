...
import { IconAlertTriangle, IconChevronLeft, IconSearch, IconEye, IconEdit, IconTrash, IconPlus } from "@tabler/icons-react";
        ...
        <Table verticalSpacing="md" highlightOnHover>
          <Table.Thead bg="gray.0">
            <Table.Tr>
              ...
              <Table.Th fw={700} fz="sm" c="dark">Original Invoice</Table.Th>
