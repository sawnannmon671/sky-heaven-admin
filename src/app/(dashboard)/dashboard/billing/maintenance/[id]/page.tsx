...
const mockData = [
  { id: "MF-2024-001", unit: "A-101", resident: "U Aung Aung", amount: "$50.00", date: "2024-10-01", dueDate: "2024-10-05", status: "Paid", items: [{ desc: "Monthly Maintenance Fee", qty: 1, price: "$50.00", total: "$50.00" }] },
  { id: "MF-2024-002", unit: "B-205", resident: "Daw Su Su", amount: "$60.00", date: "2024-10-01", dueDate: "2024-10-05", status: "Unpaid", items: [{ desc: "Monthly Maintenance Fee", qty: 1, price: "$60.00", total: "$60.00" }] },
  { id: "MF-2024-003", unit: "C-304", resident: "U Kyaw Min", amount: "$55.00", date: "2024-10-01", dueDate: "2024-10-05", status: "Paid", items: [{ desc: "Monthly Maintenance Fee", qty: 1, price: "$55.00", total: "$55.00" }] },
  { id: "MF-2024-004", unit: "A-502", resident: "Daw Hla Hla", amount: "$50.00", date: "2024-10-01", dueDate: "2024-10-05", status: "Overdue", items: [{ desc: "Monthly Maintenance Fee", qty: 1, price: "$50.00", total: "$50.00" }] },
  { id: "MF-2024-005", unit: "D-102", resident: "U Zaw Myo", amount: "$70.00", date: "2024-10-01", dueDate: "2024-10-05", status: "Paid", items: [{ desc: "Monthly Maintenance Fee", qty: 1, price: "$70.00", total: "$70.00" }] },
];
    ...
    <Stack gap="xl" p="md" style={{ maxWidth: 1000, margin: '0 auto' }}>
      <Group justify="space-between" align="center">
        <Group gap="sm">
          ...
          <Title order={2} c="#014F86">Monthly Maintenance Fees Details</Title>
        </Group>
        <Button 
          component={Link} 
          href="../" 
        ...
        {item ? (
          ...
          <Paper p="xl" radius="xl" withBorder shadow="sm" style={{ backgroundColor: '#ffffff' }}>
            <Stack align="center" py="xl">
              ...
              <Text c="dimmed" ta="center" maw={400}>The maintenance fee record you are looking for might have been removed or the ID is incorrect.</Text>
