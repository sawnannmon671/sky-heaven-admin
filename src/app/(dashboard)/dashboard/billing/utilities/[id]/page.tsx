      ...
      <Group justify="space-between">
        <Stack gap={4}>
          <Group gap="xs">
            ...
            <Title order={1}>Utility Bill Details</Title>
          </Group>
          <Text c="dimmed" size="md">Viewing details for utility bill ID: {id}</Text>
        </Stack>
        <Button 
          component={Link} 
          href="../" 
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="lg">
              <Group justify="space-between" align="flex-start">
                <div>
                  <Text size="xs" tt="uppercase" fw={700} c="dimmed">Bill ID</Text>
              ...
              <Grid>
                ...
                <Grid.Col span={6}>
                  ...
                  <Text fw={500}>Resident / User</Text>
                </Grid.Col>
                <Grid.Col span={6}>
                  <Text size="sm" c="dimmed" mb={4}>Amount / Value</Text>
                  <Text fw={700} c="blue.7">$150.00</Text>
                </Grid.Col>
                <Grid.Col span={6}>
              ...
              <Box mt="md">
                ...
                <Paper p="md" bg="gray.0" radius="md">
                  <Text size="sm">
                    This is a detailed view for the selected record. Additional information, metadata, and related transactions would be displayed here depending on the specific module.
                  </Text>
                </Paper>
              </Box>
            </Stack>
          ...
          <Paper p="xl" radius="lg" withBorder shadow="sm" style={{ border: '1px solid #e9ecef' }}>
            <Stack gap="md">
              ...
              <Text size="sm" c="dimmed">
                Overview of the current utility bill. Use the actions below to manage this entry.
              </Text>
              <Button fullWidth color="blue" mt="sm">Print / Download</Button>
              <Button fullWidth variant="light" color="blue">Edit Bill</Button>
