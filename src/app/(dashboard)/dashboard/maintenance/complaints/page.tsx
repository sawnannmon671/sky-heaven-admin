...
import {  IconMessageExclamation, IconChevronLeft, IconSearch, IconEye, IconEdit, IconTrash, IconPlus , IconSelector, IconChevronUp, IconChevronDown } from "@tabler/icons-react";
      ...
      <Paper p="md" radius="md" withBorder shadow="sm">
        <Box mb="xl" p="md" style={{ backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="md">
            <TextInput
              label={<Text fw={700} size="xs" mb={5}>Search Complaint</Text>}
              placeholder="Search by ID, Resident or Subject"
                ...
                <Table.Td>
                  <Group gap={4} justify="flex-end">
                    <ActionIcon 
                      ...
                      color="gray" 
                      component={Link} 
                      href={`/dashboard/maintenance/complaints/${item.id}`}
                    >
                      <IconEye size={16} />
                    </ActionIcon>
